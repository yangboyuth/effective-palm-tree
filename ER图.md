...
| 符号 | 含义 | 示例 | 说明 |
|------|------|------|------|
| `\|\|--\|\|` | **一对一 (1:1)** | 用户表 \|\|--\|\| 用户详情表 | 一个用户对应一条详情记录 |
| `\|\|--o\|` | **一对零或一 (1:0..1)** | 订单表 \|\|--o\| 支付记录表 | 一个订单最多有一条支付记录 |
| `\|\|--o{` | **一对多 (1:N)** | 用户表 \|\|--o{ 收货地址表 | 一个用户可以有多个收货地址 |
| `\|\|--\|{` | **一对至少一 (1:1..N)** | 订单表 \|\|--\|{ 订单明细表 | 一个订单至少有一条明细 |
| `}o--o{` | **多对多 (M:N)** | 学生 }o--o{ 课程 | 学生和课程互为多对多 |
